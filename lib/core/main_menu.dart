...
class _MainMenuState extends State<MainMenu> with SingleTickerProviderStateMixin {
  ...
  final features = [
    ...
    {'label': 'Plants', 'icon': Icons.local_florist, 'color': Colors.lightGreen},
    {'label': 'Geography', 'icon': Icons.map, 'color': Colors.cyan},
    {'label': 'Parts of the House', 'icon': Icons.home, 'color': Colors.brown},
    {'label': 'Vocabulary', 'icon': Icons.text_fields, 'color': Colors.deepOrange},
  ];
            ...
            child: Column(
              children: [
                ...
                const Text(
                  ...
                  style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, fontFamily: 'Nunito'),
                ),
                const SizedBox(height: 8),
                const Text(
                  'Choose a fun activity:',
                  style: TextStyle(fontSize: 18, fontFamily: 'Nunito', color: Colors.black54),
                ),
                const SizedBox(height: 16),
                Expanded(
