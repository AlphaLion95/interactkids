...
import 'modules/puzzle/puzzle_screen.dart';
import 'modules/matching/matching_screen.dart';
import 'modules/reading/reading_screen.dart';
import 'modules/writing/writing_screen.dart';
import 'modules/painting/painting_screen.dart';
import 'modules/community_helpers/community_helpers_screen.dart';
import 'modules/planets/planets_screen.dart';
import 'modules/plants/plants_screen.dart';
import 'modules/geography/geography_screen.dart';
import 'modules/parts_of_house/parts_of_house_screen.dart';
...
class InteractKidsApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'InteractKids',
      home: FutureBuilder(
        future: Future.value(Hive.box('settings').get('voice') as String?),
  ...
  void _onTapCard(BuildContext context) async {
    ...
    switch (widget.item.title) {
      ...
      case 'Vocabulary':
        ...
        break;
      default:
        screen = _ModuleScreen(title: widget.item.title);
    }
    Navigator.push(
      context,
      MaterialPageRoute(
    ...
    // Play sound and confetti after navigation
    try {
                ...
                ElevatedButton(
                  ...
                  onPressed: selectedVoice == null
                      ...
                      : () async {
                          ...
                          // Try to play welcome audio, but ignore errors and do not await
                          try {
                            VoiceAudioPlayer().play('welcome.mp3');
                          } catch (_) {}
                          if (mounted) {
