...
class MatchingGameBaseState extends State<MatchingGameBase> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    // prepare pulse controller
  _pulseController = AnimationController(vsync: this, duration: const Duration(milliseconds: 520));
  _pulseAnim = CurvedAnimation(parent: _pulseController, curve: Curves.elasticOut);
  ...
  void _triggerPulse(dynamic item) {
    try {
      ...
      // the visual stays while the bounce plays (forward+reverse).
