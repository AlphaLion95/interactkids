      ...
      child: Stack(
        ...
        children: [
          Row(
            ...
            final double desiredCellSize = widget.mode.preferredCellSize ?? 120.0; // preferred max
            ...
            final totalVerticalSpacing = (rows - 1) * 12.0 + 16.0; // row gaps + small padding
            ...
            final double cellSize = math.max(48.0, math.min(desiredCellSize, maxCellPerRow));
