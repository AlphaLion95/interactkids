...
class MatchingGameBaseState extends State<MatchingGameBase> {
  ...
  Future<void> _loadProgress() async {
    ...
    // shuffle remaining items for a fresh layout
    leftItems.shuffle();
    rightItems.shuffle();
        ...
        children: [
          Row(
            children: [
                  ...
                  builder: (context, isDrawing, child) {
                    return Padding(
                      ...
                      child: LayoutBuilder(builder: (context, constraints) {
                        ...
                        const double cellSize = 120; // match 'easy' size as max
                        const double spacing = 12;
                        final int perRow = (constraints.maxWidth ~/ (cellSize + spacing)).clamp(1, 4);
                        final int leftCount = widget.leftItems.length;
                        final int rightCount = widget.rightItems.length;
                        final int rows = math.max((leftCount + perRow - 1) ~/ perRow,
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: List.generate(perRow, (i) {
                                      ...
                                      if (idx >= widget.leftItems.length) return const SizedBox.shrink();
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: AnimatedScale(
                                            ...
                                            child: SizedBox(
                                              ...
                                              width: cellSize,
                                              height: cellSize,
                                              child: Center(child: widget.buildLeft(item)),
                                            ),
                                          ),
                                        ),
                                      );
                                  ...
                                  Row(
                                    children: List.generate(perRow, (i) {
                                      ...
                                      if (idx >= widget.rightItems.length) return const SizedBox.shrink();
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: AnimatedScale(
                                            ...
                                            child: SizedBox(
                                              ...
                                              width: cellSize,
                                              height: cellSize,
                                              child: Center(child: widget.buildRight(item)),
                                            ),
                                          ),
                                        ),
                                      );
              ...
              // Right column: non-scrolling Wrap layout
              Expanded(
                child: LayoutBuilder(builder: (context, constraints) {
                      ...
                      return Padding(
                        ...
                        child: ConstrainedBox(
                          ...
                          child: LayoutBuilder(builder: (context, c) {
                            ...
                            const double spacing = 12;
                            const int columns = 3;
                            final double gridWidth = (cellSize * columns) + (spacing * (columns - 1));
                            final double useWidth = gridWidth.clamp(0, c.maxWidth);
                            return Align(
