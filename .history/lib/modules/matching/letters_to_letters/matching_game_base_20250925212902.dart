...
class MatchingGameBaseState extends State<MatchingGameBase> {
  ...
  final ConfettiController _confettiController = ConfettiController(duration: const Duration(milliseconds: 700));
  ...
  void clearStroke() {
    ...
    try {
      if (areaState != null && areaState is dynamic && areaState.clearStroke is Function) {
        (areaState.clearStroke as Function)();
      }
    } catch (_) {}
  }
