...
class MatchingGameBaseState extends State<MatchingGameBase> with SingleTickerProviderStateMixin {
                                        ...
                                        GestureDetector(
                                          onTap: () => _onLeftTap(item),
                                            ...
                                            builder: (context, child) {
                                              ...
                                              final baseScale = selectedLeft == item ? 1.12 : 1.0;
                                              // pulse scale when this item was tapped
                                              final pulseScale = (_pulseItem == item) ? (1.0 + _pulseAnim.value * 0.32) : 1.0;
                                              // vertical bounce like a ball
                                              final translateY = (_pulseItem == item) ? _bounceAnim.value : 0.0;
                                            ...
                                            child: Container(
                                              ...
                                              child: Stack(
                                                ...
                                                children: [
                                                  Center(child: widget.mode.buildLeftItem(context, item)),
                                                  Positioned.fill(
                                                    child: IgnorePointer(
                                                      child: AnimatedOpacity(
                                                        opacity: (_tapPulse[item] == true) ? 1.0 : 0.0,
                                      ...
                                      for (final item in rightItems)
                                        GestureDetector(
                                          onTap: () => _onRightTap(item),
                                            ...
                                            animation: _pulseController,
                                            builder: (context, child) {
                                              final baseScale = selectedRight == item ? 1.12 : 1.0;
                                              final pulseScale = (_pulseItem == item) ? (1.0 + _pulseAnim.value * 0.32) : 1.0;
                                              final translateY = (_pulseItem == item) ? _bounceAnim.value : 0.0;
                                              return Transform.translate(
                                                offset: Offset(0, translateY),
                                            ...
                                            child: Container(
                                              ...
                                              child: Stack(
                                                alignment: Alignment.center,
                                                children: [
                                                  Center(child: widget.mode.buildRightItem(context, item)),
                                                  Positioned.fill(
                                                    child: IgnorePointer(
                                                      child: AnimatedOpacity(
                                                        opacity: (_tapPulse[item] == true) ? 1.0 : 0.0,
