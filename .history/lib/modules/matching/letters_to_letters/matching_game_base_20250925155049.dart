                    ...
                    return Padding(
                      ...
                      child: LayoutBuilder(builder: (context, constraints) {
                        ...
                        scale: _animating[item] == true
                          ? 1.2
                          : ((widget.tapPulse != null && widget.tapPulse![item] == true) ? 1.18 : (_selectedLeft == item ? 1.06 : 1.0)),
                                            duration:
                                                const Duration(milliseconds: 220),
                                            ...
                                            child: AnimatedContainer(
                                              ...
                                              child: Stack(
                                                alignment: Alignment.center,
                                                children: [
                                                  Center(child: widget.buildLeft(item)),
                                                  Positioned.fill(
                                                    child: IgnorePointer(
                                                      child: AnimatedOpacity(
                                                        opacity: (widget.tapPulse != null && widget.tapPulse![item] == true) ? 1.0 : 0.0,
                      ...
                      scale: _animating[item] == true
                        ? 1.2
                        : ((widget.tapPulse != null && widget.tapPulse![item] == true) ? 1.18 : (_selectedRight == item ? 1.06 : 1.0)),
                                            duration:
                                                const Duration(milliseconds: 220),
                                            curve: Curves.easeOutBack,
                                            child: AnimatedContainer(
                                              ...
                                              child: Stack(
                                                alignment: Alignment.center,
                                                children: [
                                                  Center(child: widget.buildRight(item)),
                                                  Positioned.fill(
                                                    child: IgnorePointer(
                                                      child: AnimatedOpacity(
                                                        opacity: (widget.tapPulse != null && widget.tapPulse![item] == true) ? 1.0 : 0.0,
