...
class MatchingGameBaseState extends State<MatchingGameBase> {
  ...
  void didUpdateWidget(covariant MatchingGameBase oldWidget) {
    ...
    // If the mode (and therefore pairs) changed, reload progress and items.
                  ...
                  builder: (context, isDrawing, child) {
                    return Padding(
                      ...
                      child: LayoutBuilder(builder: (context, constraints) {
                        ...
                        final double cellSize = widget.preferredCellSize ?? 120.0;
                        final int perRow =
                            1; // force exactly one item per side per row
