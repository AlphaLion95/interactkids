  ...
  final MatchingGameMode mode;
                                        GestureDetector(
                                          ...
                                          child: Builder(builder: (ctx) {
                                            final ctrl = _bounceControllers[item];
                                            ...
                                            if (ctrl != null) {
                                              final anim = CurvedAnimation(
                                                  parent: ctrl, curve: Curves.elasticOut);
                                              return AnimatedBuilder(
                                                animation: ctrl,
                                                builder: (c, ch) {
                                                  final scale = 1.0 + anim.value * 0.22;
                                                  return Transform.scale(
                                                      scale: scale, child: ch);
                                                },
                                                child: child,
                                              );
                                            }
                                            return AnimatedScale(
                                              scale: selectedLeft == item ? 1.12 : 1.0,
    ...
    final allPairs = widget.mode.pairs;
                                        GestureDetector(
                                          ...
                                          child: Builder(builder: (ctx) {
                                            ...
                                            return AnimatedScale(
                                              scale: selectedRight == item ? 1.12 : 1.0,
                                              duration: const Duration(milliseconds: 350),
                                              curve: Curves.elasticOut,
                                              child: child,
                                            );
