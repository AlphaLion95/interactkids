...
abstract class MatchingGameMode {
  ...
  /// Preferred cell size (in logical pixels) for rendering tiles in grid-based
  /// matching UIs. Modes may override to suggest different sizes for easy/hard.
  /// If null, callers should fall back to a sensible default.
