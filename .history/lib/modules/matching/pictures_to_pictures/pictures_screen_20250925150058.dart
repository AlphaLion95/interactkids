...
class _MatchingPicturesScreenState extends State<MatchingPicturesScreen> {
  ...
  Container(width: 96, height: 72, decoration: BoxDecoration(color: Colors.orangeAccent, borderRadius: BorderRadius.circular(12))),
  // solid red rounded square
  Container(width: 96, height: 96, decoration: BoxDecoration(color: Colors.redAccent.shade200, borderRadius: BorderRadius.circular(16))),
  // solid yellow pill
  Container(width: 88, height: 56, decoration: BoxDecoration(color: Colors.yellow.shade700, borderRadius: BorderRadius.circular(28))),
    // Solid triangle badge (no inner emoji)
    const _TriangleBadge(color: Colors.pink, size: 100),
    // Solid circle (no emoji inside)
    Container(width: 96, height: 96, decoration: BoxDecoration(color: Colors.yellow, shape: BoxShape.circle)),
      ],
      'medium': [
      ...
      'hard': [
        ...
        Container(width: 48, height: 48, decoration: BoxDecoration(color: Colors.blueGrey, borderRadius: BorderRadius.circular(8))),
      ],
    },
    'Vegetables': {
      'easy': [
