...
class _MatchingPicturesScreenState extends State<MatchingPicturesScreen> {
  ...
  static const Map<String, List<Widget>> _categoryWidgets = {
    'Fruits': [
  Icon(Icons.apple, size: 120, color: Colors.red),
  Icon(Icons.brightness_1, size: 120, color: Colors.orange),
  Icon(Icons.circle, size: 120, color: Colors.purple),
  Icon(Icons.star, size: 120, color: Colors.yellow),
  Icon(Icons.favorite, size: 120, color: Colors.pink),
  Icon(Icons.local_pizza, size: 120, color: Colors.deepOrange),
  Icon(Icons.cake, size: 120, color: Colors.brown),
  Icon(Icons.icecream, size: 120, color: Colors.blueGrey),
    ],
    'Vegetables': [
