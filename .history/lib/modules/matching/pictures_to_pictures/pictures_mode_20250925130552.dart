...
class MatchingPicturesMode extends MatchingGameMode {
  ...
  // Let the mode provide no explicit preferredCellSize by default. The
  // `MatchingPicturesScreen` already sizes the visuals; MatchingGameBase will
  // fall back to a default when this is null.
  @override
