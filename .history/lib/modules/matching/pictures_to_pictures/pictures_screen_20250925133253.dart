                ...
                child: Wrap(
                  ...
                  children: categories.map((cat) {
                    return GestureDetector(
                      onTap: () {
                        // Recreate the game key so the MatchingGameBase is rebuilt
                        // with a fresh State object and does not reuse old progress.
                        ...
                        // Ensure any previous saved progress is cleared for the
                        // newly selected category so the board populates.
                                ...
                                (_selectedCategory == 'Shapes' &&
                                    ...
                                    : _selectedDifficulty == 'medium'
                                        ...
                                        : _selectedDifficulty == 'hard'
                                            ? 64
                                            : 120,
                                // ensure progress is isolated per-category
                                _selectedCategory,
                              ),
                              title: '',
                            ),
