...
class MatchingWordsToPicturesMode extends MatchingGameMode {
  ...
  Widget buildLeftItem(BuildContext context, dynamic item) {
    return Container(padding: const EdgeInsets.all(8), child: Text(item as String));
  }

  @override
  Widget buildRightItem(BuildContext context, dynamic item) {
    return Container(padding: const EdgeInsets.all(8), child: Image.asset(item as String, width: 64, height: 64));
  }
}
