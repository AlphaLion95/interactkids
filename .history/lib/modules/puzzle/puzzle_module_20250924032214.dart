                              ...
                              child: Material(
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: const Center(
<<<<<<< HEAD
                                      child: Icon(Icons.arrow_back, color: Colors.orange, size: 28),
=======
...
<<<<<<< HEAD
                                        ...
                                        double boardHeight = boardWidth / _imageAspectRatio!;
...
<<<<<<< HEAD
                                                    ...
                                                    onPieceRemoved: (slotIdx) {
                                                      if (boardState[slotIdx] != null) {
                                                        _onPieceRemovedFromBoard(slotIdx, boardState[slotIdx]!);
                                                      }
                                                    },
...
<<<<<<< HEAD
                                                    ...
                                                    slotKeys: {
                                                      for (var i = 0; i < _slotKeys.length; i++) i: _slotKeys[i]
                                                    },
...
<<<<<<< HEAD
                                                      ...
                                                      : ListView.builder(
                                                          ...
                                                          itemBuilder: (context, trayIdx) {
                                                            final pieceIdx = pieceOrder[trayIdx];
