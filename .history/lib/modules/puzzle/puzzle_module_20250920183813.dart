          ...
          child: DragTarget<int>(
            ...
            builder: (context, candidateData, rejectedData) {
              if (pieceIdx != null) {
                ...
                // empty slot: show highlight if the dragged piece visually overlaps the slot
                bool isHighlighted = false;
                if (dragGlobalPosition != null && draggingPieceIdx != null && key != null) {
                  final renderBox = key.currentContext?.findRenderObject() as RenderBox?;
                  if (renderBox != null) {
                    final slotRect = renderBox.localToGlobal(Offset.zero) & renderBox.size;
                    // Determine dragRect size: if dragging from tray, use 88x88; if from board, use tileWidth/tileHeight
                    ...
                    final dragRect = Rect.fromCenter(center: dragGlobalPosition!, width: dragW, height: dragH);
                    if (slotRect.overlaps(dragRect)) {
                      isHighlighted = true;
                    }
                  }
                }
