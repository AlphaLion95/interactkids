                              ...
                              GestureDetector(
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    // Invisible edit/delete for alignment, never block taps
                                    Positioned(
                                      top: 2,
                                      right: 2,
                                      child: IgnorePointer(
  ...
  final double progress;
    return Stack(
      ...
      children: [
        ...
        // If there are invisible edit/delete buttons, wrap them in IgnorePointer so they never block taps
        Positioned.fill(
          child: IgnorePointer(
            child: Container(),
          ),
                    ...
                    SizedBox(
                      ...
                      child: Builder(
                        builder: (context) {
                          ...
                          final percent = placed / total;
                          final isComplete = percent == 1.0 && boardState.asMap().entries.every((e) => e.value == e.key);
