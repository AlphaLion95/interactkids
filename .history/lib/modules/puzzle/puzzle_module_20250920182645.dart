          ...
          child: DragTarget<int>(
            ...
            builder: (context, candidateData, rejectedData) {
              if (pieceIdx != null) {
                ...
                if (dragGlobalPosition != null && draggingPieceIdx != null && draggingPieceIdx == index && key != null) {
                  final renderBox = key.currentContext?.findRenderObject() as RenderBox?;
                  if (renderBox != null) {
                    final slotRect = renderBox.localToGlobal(Offset.zero) & renderBox.size;
                    // Assume drag feedback is about 88x88 (same as tray piece)
                    final dragRect = Rect.fromCenter(center: dragGlobalPosition!, width: 88, height: 88);
