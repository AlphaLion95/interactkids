  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      if (dragGlobalPosition != null && draggingPieceIdx != null) {
        ...
        double dragW = tileWidth;
        double dragH = tileHeight;
        dragRect = Rect.fromCenter(
            center: dragGlobalPosition!, width: dragW, height: dragH);
        // For each empty slot, highlight the first one with any overlap (1 pixel)
        for (int index = 0; index < rows * cols; index++) {
          ...
          // Inflate slot rect for easier highlighting (optional, e.g. 6px)
            ...
            builder: (context, candidateData, rejectedData) {
              if (pieceIdx != null) {
                ...
                return Draggable<int>(
                  ...
                  // No need for onDragUpdateFromBoard, highlight is unified
