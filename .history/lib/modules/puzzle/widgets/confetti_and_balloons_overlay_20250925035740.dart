...
class ConfettiAndBalloonsOverlay extends StatefulWidget {
  ...
  const ConfettiAndBalloonsOverlay(
      {Key? key, required this.show, this.onAllBalloonsPopped})
      : super(key: key);
...
class _ConfettiAndBalloonsOverlayState
    extends State<ConfettiAndBalloonsOverlay> {
...
class _AnimatedBalloonState extends State<_AnimatedBalloon>
  ...
  void initState() {
    ...
    _controller = AnimationController(
        vsync: this, duration: Duration(seconds: (5 ~/ widget.speed)));
    _controller.forward();
  }
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        final double top = (1.0 - _controller.value) *
