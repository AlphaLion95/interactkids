  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      if (dragGlobalPosition != null && draggingPieceIdx != null) {
        ...
        // For each empty slot, highlight the first one with any overlap
          ...
          child: DragTarget<int>(
            ...
            builder: (context, candidateData, rejectedData) {
              if (pieceIdx != null) {
                ...
                // Use slot size for feedback when dragging from board, 88x88 when from tray
                final bool fromTray = trayPieces != null && trayPieces!.contains(pieceIdx);
                final double feedbackW = fromTray ? 88 : tileWidth;
                final double feedbackH = fromTray ? 88 : tileHeight;
                final Offset feedbackOffset = fromTray ? const Offset(-44, -44) : Offset(-tileWidth / 2, -tileHeight / 2);
                return Draggable<int>(
                  data: pieceIdx,
                  feedback: Material(
                    color: Colors.transparent,
                    child: Transform.translate(
                      // Center the feedback under the finger
