  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      if (dragGlobalPosition != null && draggingPieceIdx != null) {
        ...
        // For each empty slot, highlight the first one with >= 20% overlap
        for (int index = 0; index < rows * cols; index++) {
          ...
          if (dragRect.overlaps(slotRect)) {
            ...
            final pieceArea = dragRect.width * dragRect.height;
            if (pieceArea > 0 && overlapArea / pieceArea >= 0.2) {
          ...
          child: DragTarget<int>(
            ...
            builder: (context, candidateData, rejectedData) {
              if (pieceIdx != null) {
                ...
                // Always use slot size for feedback and center under finger
                return Draggable<int>(
                  ...
                  onDragUpdate: (details) {
                    if (onDragUpdateFromBoard != null) {
                      ...
                      Offset globalPos;
                      if (renderBox != null) {
                        globalPos = renderBox.localToGlobal(details.localPosition);
                      } else {
                        // Fallback: use details.globalPosition if renderBox is null
