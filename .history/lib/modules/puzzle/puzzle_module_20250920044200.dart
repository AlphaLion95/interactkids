  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final double offsetX = -col * tileWidth;
        final double offsetY = -row * tileHeight;
        Widget image = Image(
          image: imageProvider,
          fit: BoxFit.cover,
          width: fullWidth,
        ...
        Widget piece = Transform.translate(
          offset: Offset(offsetX, offsetY),
          child: image,
        );
        if (!miniature) {
          // Board: show only the correct region
          return ClipRect(
            child: SizedBox(
              width: tileWidth,
              height: tileHeight,
          ...
          // Tray: scale down the piece, but show only the correct region
          return AspectRatio(
