...
class _PuzzleScreenState extends State<PuzzleScreen> {
  ...
  void _onPieceDroppedToBoard(int slotIdx, int pieceIdx) {
    setState(() {
      if (boardState[slotIdx] == null && pieceOrder.contains(pieceIdx)) {
  ...
  void _onPieceRemovedFromBoard(int pieceIdx) {
    setState(() {
      final boardIdx = boardState.indexOf(pieceIdx);
      if (boardIdx != -1) {
                                      ...
                                      return Column(
                                        ...
                                        children: [
                                          Expanded(
                                            child: Listener(
                                              onPointerDown:
                                                  (_) {}, // absorb pointer for drag target
