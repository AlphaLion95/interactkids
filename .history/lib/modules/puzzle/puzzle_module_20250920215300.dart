                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return Draggable<int>(
                                          ...
                                          onDragUpdate: (details) {
                                            // Call the board's onDragUpdate callback so highlight logic works
                                            if (_slotKeys[0]?.currentContext != null) {
                                              final boardBox = _slotKeys[0]!.currentContext!.findRenderObject() as RenderBox?;
                                              if (boardBox != null && _puzzleBoardOnDragUpdate != null) {
