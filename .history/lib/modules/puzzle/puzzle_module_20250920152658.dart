...
class _PuzzlePiece extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final testProvider = AssetImage('assets/puzzle/zoo_easy_0.png');
    print('DEBUG: _PuzzlePiece testProvider=$testProvider row=$row col=$col');
              ...
              Transform.translate(
                ...
                child: Image(
                  ...
                  errorBuilder: (context, error, stackTrace) {
                    print('ERROR: Failed to load image in _PuzzlePiece: $error');
                    return Container(
