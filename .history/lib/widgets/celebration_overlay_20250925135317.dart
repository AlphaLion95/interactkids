...
class _CelebrationOverlayState extends State<CelebrationOverlay>
  ...
  void initState() {
    ...
    try {
      ...
      // If platform audio initialization fails, swallow the error so the
      // app can continue. We guard uses of _audioPlayer elsewhere.
      _audioPlayer = null;
    }
  ...
  Future<void> _start() async {
    ...
    if (_audioPlayer != null) {
      try {
        await _audioPlayer!.setAsset('assets/audio/sfx/card_tap.mp3');
        _audioPlayer!.play();
      } catch (_) {
        // ignore audio playback errors for robustness during startup
      }
    }
