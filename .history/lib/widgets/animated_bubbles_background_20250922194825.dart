    ...
    _bubbles = [
      ...
      ...List.generate(
          ...
          (i) => _Bubble.randomWithRadius(10, 18,
              speed: 0.18, colorSet: _Bubble.vibrantColors)),
      // Medium
      ...List.generate(
          6,
          (i) => _Bubble.randomWithRadius(22, 32,
              speed: 0.22, colorSet: _Bubble.vibrantColors)),
      // Large
      ...List.generate(
          4,
          (i) => _Bubble.randomWithRadius(38, 54,
              speed: 0.26, colorSet: _Bubble.vibrantColors)),
      // Extra Large
      ...List.generate(
          2,
          (i) => _Bubble.randomWithRadius(60, 80,
              speed: 0.30, colorSet: _Bubble.vibrantColors)),
      // Double Extra Large
      ...List.generate(
          1,
          (i) => _Bubble.randomWithRadius(100, 140,
              speed: 0.34, colorSet: _Bubble.vibrantColors)),
    ];
  }
